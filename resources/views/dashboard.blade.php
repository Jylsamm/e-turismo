...
=======
                ...
                <div class="flex items-center justify-between sm:justify-start w-full sm:w-auto gap-2.5 sm:gap-3">
                    ...
                    <div class="relative z-50 flex-1 sm:flex-initial" x-data="{ showRangeDropdown: false }"
                        @click.away="showRangeDropdown = false">
>>>>>>> Stashed changes
            ...
            <h3 class="text-2xl sm:text-3xl font-extrabold text-slate-800 mb-5">Executive Summary</h3>
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 mb-8">
                <!-- Active Tourists -->
                <div
                    class="overflow-hidden rounded-2xl bg-white shadow-sm border border-gray-100 flex flex-col relative admin-card-hover">
                    ...
                    <div class="p-6 flex-grow">
                        <div class="flex items-center gap-4">
                            <div class="flex-shrink-0 bg-emerald-100 rounded-xl p-3.5">
                                <svg class="h-7 w-7 text-emerald-600" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="min-w-0">
                                <p class="text-sm sm:text-base font-bold text-slate-500 leading-tight">Active Tourists
                                </p>
                                <p class="text-3xl sm:text-4xl font-extrabold text-slate-900 leading-tight mt-1"
                                    x-text="kpis.activeTourists">...</p>
                            </div>
                        </div>
                    </div>
                    <div class="bg-gray-50 border-t border-gray-100 p-0 h-[44px] w-full" id="sparkline-tourists"></div>
                </div>
                ...
                <div
                    ...
                    <div class="p-6 flex-grow">
                        <div class="flex items-center gap-4">
                            <div class="flex-shrink-0 bg-amber-100 rounded-xl p-3.5">
                                <svg class="h-7 w-7 text-amber-600" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="min-w-0">
                                <p class="text-sm sm:text-base font-bold text-slate-500 leading-tight">Pending Bookings
                                </p>
                                <p class="text-3xl sm:text-4xl font-extrabold text-amber-600 leading-tight mt-1"
                                    x-text="kpis.pendingRequests">...</p>
                            </div>
                        </div>
                    </div>
                    <div class="bg-amber-50/50 border-t border-gray-100 p-0 h-[44px] w-full cursor-pointer hover:bg-amber-50 transition-colors"
                ...
                <div
                    ...
                    <div class="p-6 flex-grow">
                        <div class="flex items-center gap-4">
                            <div class="flex-shrink-0 bg-teal-100 rounded-xl p-3.5">
                                <svg class="h-7 w-7 text-teal-600" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="min-w-0">
                                <p class="text-sm sm:text-base font-bold text-slate-500 leading-tight">Capacity Health
                                </p>
                                <p class="text-3xl sm:text-4xl font-extrabold text-slate-900 leading-tight mt-1"
                                    x-text="kpis.capacityHealth + '%'">...</p>
                            </div>
                        </div>
                    </div>
                    <div class="bg-gray-50 border-t border-gray-100 p-0 h-[44px] w-full" id="sparkline-capacity"></div>
                </div>
                ...
                <div
                    ...
                    <div class="p-6 flex-grow">
                        <div class="flex items-center gap-4">
                            ...
                            <div class="min-w-0">
                                <p class="text-sm sm:text-base font-bold text-slate-500 leading-tight">QR Check-ins</p>
                                <p class="text-3xl sm:text-4xl font-extrabold text-slate-900 leading-tight mt-1"
                                    x-text="kpis.qrScans">...</p>
                            </div>
                        </div>
                    </div>
                    <div class="bg-gray-50 border-t border-gray-100 p-0 h-[44px] w-full" id="sparkline-qr"></div>
                </div>
            </div>

            <!-- Tier 2: Core Charts -->
            <h3 class="text-2xl sm:text-3xl font-extrabold text-slate-800 mb-5">Core Analytics</h3>
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                <!-- Dual-Axis Area Chart: Check-ins vs Bookings -->
                <div
                    class="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-7 relative admin-card-hover">
                    <h3 class="text-lg sm:text-xl font-bold text-slate-800 mb-4">Check-ins vs Bookings</h3>
                ...
                <div
                    class="bg-white rounded-3xl shadow-sm border border-slate-100 p-6 sm:p-7 relative flex flex-col admin-card-hover">
                    <div class="flex justify-between items-center mb-3">
                        <h3 class="text-lg sm:text-xl font-black text-slate-900 tracking-tight"
                            x-text="donutTab === 'demographics' ? 'Visitor' : 'Booking'"></h3>
                        <!-- Tabs -->
                        <div
                            class="inline-flex items-center p-1 bg-slate-100 rounded-xl border border-slate-200/60 gap-1">
                            <button @click="setDonutTab('demographics')"
                                :class="donutTab === 'demographics' ? 'bg-white shadow-xs text-slate-900 font-bold' : 'text-slate-500 hover:text-slate-800 font-semibold'"
                                class="px-3 py-1.5 text-xs sm:text-sm rounded-lg transition-all cursor-pointer">Demo</button>
                            <button @click="setDonutTab('status')"
                                :class="donutTab === 'status' ? 'bg-white shadow-xs text-slate-900 font-bold' : 'text-slate-500 hover:text-slate-800 font-semibold'"
                                class="px-3 py-1.5 text-xs sm:text-sm rounded-lg transition-all cursor-pointer">Status</button>
                        </div>
                    </div>
                ...
                <div x-show="broadcastStep === 'form'" class="space-y-4">
                    ...
                    <div x-data="{ showAudienceDropdown: false }">
                        ...
                        <div class="relative">
                            ...
                            <button type="button" @click="showAudienceDropdown = !showAudienceDropdown"
                                @click.away="showAudienceDropdown = false"
                                class="flex justify-between items-center w-full rounded-xl border border-gray-250 bg-white px-3 py-2.5 text-sm text-gray-700 font-semibold hover:bg-gray-50 transition focus:outline-none focus:ring-2 focus:ring-emerald-500 shadow-sm">
                                <span x-text="
                                ...
                                "></span>
                                <svg class="h-4 w-4 text-gray-450 transform transition-transform duration-200 shrink-0 ml-1"
                                    :class="showAudienceDropdown ? 'rotate-180' : ''" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                            ...
                            <!-- Dropdown Menu -->
                            <div x-show="showAudienceDropdown" x-transition:enter="transition ease-out duration-150"
                                ...
                                style="display: none;">
                                <button type="button"
                                    @click="broadcastForm.audience = 'all'; showAudienceDropdown = false"
                                    class="w-full text-left px-4 py-2.5 text-sm hover:bg-green-50/40 hover:text-green-950 transition-colors">
                                    All Active Users
                                </button>
                                <button type="button"
                                    @click="broadcastForm.audience = 'active_bookings'; showAudienceDropdown = false"
                                    class="w-full text-left px-4 py-2.5 text-sm hover:bg-green-50/40 hover:text-green-950 transition-colors">
                                    Users with Active Bookings
                                </button>
                                <button type="button"
                                    @click="broadcastForm.audience = 'destination'; showAudienceDropdown = false"
                                    class="w-full text-left px-4 py-2.5 text-sm hover:bg-green-50/40 hover:text-green-950 transition-colors">
                    ...
                    <div x-show="broadcastForm.audience === 'destination'" x-transition
                        x-data="{ showDestDropdown: false }">
                        <label class="block text-sm font-semibold text-gray-700 mb-1 mt-4">Select Destination</label>
                        <div class="relative">
                            <!-- Dropdown Trigger Button -->
                            <button type="button" @click="showDestDropdown = !showDestDropdown"
                                @click.away="showDestDropdown = false"
                                class="flex justify-between items-center w-full rounded-xl border border-gray-250 bg-white px-3 py-2.5 text-sm text-gray-700 font-semibold hover:bg-gray-50 transition focus:outline-none focus:ring-2 focus:ring-emerald-500 shadow-sm">
                                <span x-text="
                                ...
                                "></span>
                                <svg class="h-4 w-4 text-gray-450 transform transition-transform duration-200 shrink-0 ml-1"
                                    :class="showDestDropdown ? 'rotate-180' : ''" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"
                                        d="M19 9l-7 7-7-7" />
                                </svg>
                            ...
                            <!-- Dropdown Menu -->
                            <div x-show="showDestDropdown" x-transition:enter="transition ease-out duration-150"
                                x-transition:enter-start="opacity-0 scale-95"
                                x-transition:enter-end="opacity-100 scale-100"
                                x-transition:leave="transition ease-in duration-100"
                                x-transition:leave-start="opacity-100 scale-100"
                                ...
                                class="absolute left-0 mt-1.5 z-50 w-full rounded-xl bg-white border border-gray-200 shadow-xl py-1 max-h-48 overflow-y-auto"
                                style="display: none;">
                                <button type="button" @click="broadcastForm.destination = ''; showDestDropdown = false"
                                    class="w-full text-left px-4 py-2.5 text-sm hover:bg-green-50/40 hover:text-green-950 transition-colors">
                                    -- Select Destination Spot --
                                </button>
                                <template x-for="dest in destinationsList" :key="dest.id">
                                    <button type="button"
                                        @click="broadcastForm.destination = dest.id; showDestDropdown = false"
                                        class="w-full text-left px-4 py-2.5 text-sm hover:bg-green-50/40 hover:text-green-950 transition-colors"
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('analyticsDashboard', () => ({
                ...
                renderDonutChart() {
                    ...
                    const seriesValues = isAllZero
                        ? (this.donutTab === 'demographics' ? [18, 7, 9, 4] : [15, 4, 2])
                        : data.values;

                    const isDemo = this.donutTab === 'demographics';
                    const colors = isDemo
                        ? ['#047857', '#059669', '#10b981', '#34d399'] // Deep-to-bright emerald & aquamarine
                        : ['#059669', '#d97706', '#e11d48']; // Emerald (Approved), Amber (Pending), Rose (Cancelled)
                        ...
                        tooltip: {
                            ...
                            y: {
                                formatter: function (val) {
                                    return val + ' ' + (isDemo ? 'Visitors' : 'Bookings');
                                }
                            }
                        },
                        plotOptions: {

                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="col-span-2">
                        ...
                        <input type="text" name="name" value="{{ old('name', $destination->name) }}"
                            class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-brand-400 outline-none"
                            required>
                    </div>
                    <div>
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea name="description" rows="3"
                            class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-brand-400 outline-none resize-none">{{ old('description', $destination->description) }}</textarea>
                    </div>
                    <div class="col-span-2">
